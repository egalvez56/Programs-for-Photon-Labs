...
% Kiko Galvez modified it in June-July 2021, 4/22.                              %
%                                                                         %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc;
clear;
...
defaultans = {'COM20','1','4','0.02','1','Double'};%[1 length(dlg_title)+10],[1 5;1 5;1 5;1 30]
...
f1=figure('Name','Tomography Data Recording','numbertitle','off','Position',screensize,'color',[0.7 0.7 0.7]);
% hold on
...
flushinput(CD48serial)
    ...
    while ~isequal(count,loop+1) % outer loop measurements per voltage step
        ...
        descr = [' Voltage Scan:',num2str(VtoCD48),' Time per step = ',num2str(timeinterval),' s'];
