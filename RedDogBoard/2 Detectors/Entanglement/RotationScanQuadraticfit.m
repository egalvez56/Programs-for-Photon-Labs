...
% Modified to rotate the quartz plate to fin the minimum in DA
% correlations. It records a scan of the rotation of the quartz plate
% with Alice and Bob at D and A, respectively. HWP for the pump
% is set for equal amounts of HH and VV. After the scan, which has points
...
defaultans = {'COM20','COM16','0','70','5','2','Quartzplate'};%[1 length(dlg_title)+10],[1 5;1 5;1 5;1 30]
...
xhi = input(prompt);
countfitlo=floor(xlo/Increment);
countfithi=floor(xhi/Increment);
