...
Header = sgtitle( gcf, 'Valeria Continous Counting', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2, 'Color','w');
...
uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.045 0.61 0.2 0.05], ...
...
TitleA = uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.22 0.61 0.1 0.05], ...
...
set( gca, 'XGrid','on', 'YGrid','on', 'LineWidth',2, 'XLim', [0 Inf], 'YLim', [0 Inf], 'FontSize',fs1 );
% set( gca, 'XLim', [0, Nstates+1], 'XTick',1:Nstates, 'XTickLabel',States, 'FontSize',fs1, 'XTickLabelRotation',0 )
uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.38 0.61 0.2 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','left', ...
    'String','Singles B', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2 )
TitleB = uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.555 0.61 0.1 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','right', ...
    'String','1', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2 );
...
set( gca, 'XGrid','on', 'YGrid','on', 'LineWidth',2, 'XLim', [0 Inf], 'YLim', [0 Inf], 'FontSize',fs1 );
% set( gca, 'XLim', [0, Nstates+1], 'XTick',1:Nstates, 'XTickLabel',States, 'FontSize',fs1, 'XTickLabelRotation',0 )
uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.715 0.61 0.2 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','left', ...
    'String','Coincidences AB', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2 )
TitleAB = uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.89 0.61 0.1 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','right', ...
    'String','1', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2 );

uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.715 0.1 0.2 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','left', ...
    'String','Accidentals', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2 )

TitleAcc = uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.89 0.1 0.1 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','right', ...
    'String','1', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2 );

uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.1 0.05 0.2 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','left', ...
    'String','Info', 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs2 )

DateTime = uicontrol( fig, 'Style','text', 'Units','normalized', 'Position',[0.15 0.05 0.2 0.05], ...
    'ForegroundColor','k', 'BackgroundColor',BGcolor, 'HorizontalAlignment','right', ...
...
fs = 12;
uicontrol( fig, 'Style','text', 'String','Select COM port','Units','normalized', 'Position',[0.05 0.9 0.2 0.05], ...
...
PortMenu = uicontrol( fig, 'Style','popupmenu', 'String',COMs, 'FontSize',fs, ...
    'Units','normalized', 'Position',[0.05 0.87 0.1 0.05] );

%%% Write integration time
uicontrol( fig, 'Style','text', 'String','Type integration time (s)','Units','normalized', 'Position',[0.05 0.82 0.2 0.05], ...
    'BackgroundColor', BGcolor, 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs, 'HorizontalAlignment','left' )
TimeEdit = uicontrol( fig, 'Style','edit', 'String','1', 'FontSize',fs, ...
    'Units','normalized', 'Position',[0.05 0.81 0.1 0.025] );

%%% Create button to start and end acqusition
RunButton = uicontrol( fig, 'Style', 'togglebutton', 'String','Start !', 'Value',0, ...
    'Units','normalized', 'Position',[0.05 0.72 0.1 0.05], ...
...
ClearButton = uicontrol( fig, 'Style', 'togglebutton', 'String','Clear graphs', 'Value',0, ...
    'Units','normalized', 'Position',[0.18 0.72 0.1 0.05], ...
    'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs1 );

%%% Accidentals time window
uicontrol( fig, 'Style','text', 'String','Type coincidence window (ns)','Units','normalized', 'Position',[0.05 0.1 0.2 0.05], ...
    'BackgroundColor', BGcolor, 'FontName','TimesNewRoman', 'FontWeight','bold', 'FontSize',fs, 'HorizontalAlignment','left' )
CoincwEdit = uicontrol( fig, 'Style','edit', 'String','32', 'FontSize',fs, ...
    'Units','normalized', 'Position',[0.05 0.1 0.1 0.025] );
...
while RunButton.Value == 1
    ...
    TitleAcc.String = num2str(Data(n,4));
