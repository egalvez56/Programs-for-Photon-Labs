%
% PiezoScan2Det23VR 
% Program that takes data from 2 photon detectors while scanning a voltage
% generated by an Arduino board that is externally amplified to drive a
% piezo-electric.
...
prompt = {'Enter the COM# of the Counter:','Enter the COM# of Stage:',...
    ...
    'File name','Info on the scan:'};
dlg_title = 'Quantum lab Inputs for Piezo Scan';
%defaultans = {'COM4','COM12','0','400','40','1','Mot','This is a test'};%[1 length(dlg_title)+10],[1 5;1 5;1 5;1 30]
defaultans = {'COM4','COM6','1','6','1','1','Eraser2genTest','This is a test'};%[1 length(dlg_title)+10],[1 5;1 5;1 5;1 30]
...
TimeInterval = str2double(UserInput{6}); % integration time for each measurement in seconds
...
%     nState = States{n};
    ...
    %%% Send the voltage to the piezo through Arduino
...
set( gca, 'XLim', [Mstart, Mend]);%%, 'XTick',1:Nstates )
...
%sArduino = serialport(UserInput{2},115200,'DataBits',8,'StopBits',1,'Parity','none');
