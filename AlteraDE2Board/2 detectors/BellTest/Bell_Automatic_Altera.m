...
prompt = {'Enter the COM# of the Counter:','Enter the COM# of Alice',...
    'Enter the COM# of Bob','time per measurement','Name of file = '};
dlg_title = 'Bell test general parameters';
%defaultans = {'COM6','1','Bell'};%[1 length(dlg_title)+10],[1 5;1 5;1 5;1 30]
defaultans = {'COM21','COM12','COM15','1','Bell'};%[1 length(dlg_title)+10],[1 5;1 5;1 5;1 30]
...
set(ax1,'XTicklabel',{'ab','a`b','a+b','a`+b','ab`','a`b`','a+b`','a`+b`','ab+','a`b+','a+b+','a`+b+','ab`+','a`b`+','a+b`+','a`+b`+'});
