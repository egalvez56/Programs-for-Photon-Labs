...
% Program that takes data from 3 photon detectors while scanning a Piezo 
% actuator via Arduino
% Created by Kiko Galvez 2/28/24 used another program as template
%
...
%%% User input
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
prompt = {'Counter COM','Arduino COM:','Start Distance ','End Distance ',...
    'Increment ','time interval','Excel file name','Info on scan:'};
dlg_title = 'Quantum lab Inputs for Piezo Scan';
defaultans = {'COM25','COM31','0','6','0.05','2','Test','Test'};%[1 length(dlg_title)+10],[1 5;1 5;1 5;1 30]
userinput = inputdlg(prompt,dlg_title,[1 length(dlg_title)+30],defaultans);
Counter = userinput{1};
sArduino = userinput{2}; % COM# for the Arduino.   
...
%%% Measurement
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
UserInput = { Counter, sArduino, Mstart, Mend, Minc, TimeInterval, NumofMeasurements, filename, info};
...
%%% Setup counter
[ scounter, sArduino ] = OpenCOMports( UserInput );
...
%if n <= Nstates
    ...
    disp(Mcurr);
    VtoArduinos = num2str(Mcurr);
    writeline( sArduino, VtoArduinos );
%    pause(1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ scounter, sArduino ] = OpenCOMports( UserInput )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%% Counter
scounter = serialport(UserInput{1},19200,'DataBits',8,'StopBits',1,'Parity','none');
%sArduino = serialport(UserInput{2},9600); % Pacific Motor
sArduino = serialport(UserInput{2},115200); % Arduino interface
